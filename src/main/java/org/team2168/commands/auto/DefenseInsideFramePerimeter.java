...
public class DefenseInsideFramePerimeter extends CommandGroup {
  /**
   * Add your docs here.
   */
  public DefenseInsideFramePerimeter() {
    // Add Commands here:
    ...
    // arm.
    addParallel(new RetractHatchPlunger());
    addParallel(new MoveMonkeyBarToStowPosition());
  }
}
