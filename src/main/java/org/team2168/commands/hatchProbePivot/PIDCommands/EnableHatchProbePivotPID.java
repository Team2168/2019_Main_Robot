...
public class EnableHatchProbePivotPID extends Command {
  ...
  public EnableHatchProbePivotPID() {
 // Use requires() here to declare subsystem dependencies
  ...
  public EnableHatchProbePivotPID(double setPoint)
  {
    this.setPoint = setPoint;
  }

  public EnableHatchProbePivotPID(double setPoint, double maxSpeed)
  {
    this.setPoint = setPoint;
    this.maxSpeed = maxSpeed;
  }

  public EnableHatchProbePivotPID(double setPoint, double maxSpeed, double minSpeed)
  {
    this.setPoint = setPoint;
    this.maxSpeed = maxSpeed;
  ...
  public EnableHatchProbePivotPID(double setPoint, double maxSpeed, double minSpeed, boolean absolute)
  {
    this.setPoint = setPoint;
    this.maxSpeed = maxSpeed;
    this.minSpeed = minSpeed;
  ...
  public EnableHatchProbePivotPID(double setPoint, double maxSpeed, double minSpeed, double error)
  {
    this.setPoint = setPoint;
    this.maxSpeed = maxSpeed;
    this.minSpeed = minSpeed;
  ...
  public EnableHatchProbePivotPID(double setPoint, double maxSpeed, double minSpeed, double error, boolean absolute)
  {
    this.setPoint = setPoint;
    this.maxSpeed = maxSpeed;
    this.minSpeed = minSpeed;
