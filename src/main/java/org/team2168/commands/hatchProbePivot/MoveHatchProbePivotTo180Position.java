...
public class MoveHatchProbePivotTo180Position extends CommandGroup {
  ...
  public MoveHatchProbePivotTo180Position() {
    ...
    if(Robot.isPracticeRobot())
      addSequential(new DriveHatchProbePivotPID(RobotMap.PIVOT_180_POS_PBOT, 0.5, 0, true));
    else
      addSequential(new DriveHatchProbePivotPID(RobotMap.PIVOT_180_POS, 0.5, 0, true));
  }
}
