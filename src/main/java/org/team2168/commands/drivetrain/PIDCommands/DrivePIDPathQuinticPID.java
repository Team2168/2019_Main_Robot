...
public class DrivePIDPathQuinticPID extends Command
{
	...
	public DrivePIDPathQuinticPID(double distance, boolean reverseDirection)
	{
		...
		aff_term = SmartDashboard.getNumber("FF_term", 0);
	}
	...
	public DrivePIDPathQuinticPID(double[] setPointLeftVel, double[] setPointRightVel, boolean reverseDirection)
	{
		...
		this.setPointRightVel = setPointRightVel;
		SmartDashboard.putNumber("FF_term", 0);
		vff_term = SmartDashboard.getNumber("FF_term", 0);
	...
	protected void execute()
	{
		...
		{
			double speedLeft = (vff_term * setPointLeftVel[counter]) / (Robot.pdp.getBatteryVoltage());
			double speedRight = (vff_term * setPointRightVel[counter]) / (Robot.pdp.getBatteryVoltage());
			...
			Robot.drivetrain.tankDrive(speedLeft + accelLeft + headingCorrection + leftPID,
					speedRight + accelRight - headingCorrection + rightPID);
